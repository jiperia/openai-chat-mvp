...
// Zweck: 3-Punkte-Popover mit Caret (Teilen / Umbenennen / Löschen).
// Hinweis: onRename wird vom ListItem bereits mit Prompt umwickelt –
//          hier nur Callback auslösen.
...
const Divider = () => <div style={{ height: 1, background: C.border, opacity: 0.7 }} />;

const PenIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    <path
      d="M4 21h4l11-11a2.828 2.828 0 10-4-4L4 17v4z"
      stroke={C.text}
      strokeWidth="1.7"
      strokeLinecap="round"
...
const TrashIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    <path
      d="M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2m1 0-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"
      stroke={C.red}
      strokeWidth="1.7"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const LinkIcon = ({ color = C.text }) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    <path
      d="M15 8a3 3 0 1 0-2.83-4h0L7 9m2 6 5.17 5a3 3 0 1 0 2.83-4"
      stroke={color}
      strokeWidth="1.7"
      strokeLinecap="round"
      strokeLinejoin="round"
